		...
		\section{Literature Review}
			...
			As this is a fundamental element to this project, each stage of calibration will be covered in a little more detail.
				...
				\begin{center}
					...
					\caption{Pinhole camera model as shown in \protect\citeasnoun[p. 372]{definition:cv} {\label{pinhole}}}
				\end{center}
				\end{figure}
				...
				\begin{center}
					...
					\caption{Pinhole camera model with image plane in front, as shown in \protect\citeasnoun[p. 372]{definition:cv} {\label{pinhole2}}}
				\end{center}
				\end{figure}
