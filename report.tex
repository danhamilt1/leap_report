...
\begin{document}
	...
	\section{Iteration 1}\label{sec:p1}
		...
		An example of one of these images is shown in figure~\ref{fig:image_1}. %FIGURE HERE
		\begin{figure}
			\centering
		...
		\lstinputlisting[caption=Convert \code{Image} type to \code{Mat} type, label=lst:crop]{cropImage.java}
...
%		StereoSGBM stands for the semi-global block matching algorithm.
%		An example disparity produced using this algorithm can be seen in figure~(INSERT IMAGE HERE).
