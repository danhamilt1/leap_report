	...
	\chapter{Introduction}\label{chap:introduction}
		...
		\section{The Leap Motion Controller}
			\subsection{What is the Leap Motion?}
				...
				The leap motion is an extremely accessible device and it can be purchased for a price of about \pounds55\footnote{\url{http://www.amazon.co.uk/Leap-Motion-Controller-Interacts-Airspace/dp/B00C66Z9ZC}}.
			...
			\subsection{Why use the Leap Motion?}
				...
				To try and find out whether it is feasible to say that a leap motion can be used for computer vision.
				For example, to detect objects other than hands and tools.
