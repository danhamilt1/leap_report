	...
	\chapter{Introduction}\label{chap:introduction}
		...
		\section{Solution Approach}	
			...
			\subsection{Planned Iterations}
					During each iteration a prototype application will be developed that will make use of the framework.
					The development of this prototype will depend upon what level to which the framework is completed.
					It will also act as a test bench for the framework.
					...
					The initial requirements will be established so that a high level design can be accomplished.
					It is hoped that most of the image utility functionality will be implemented in this stage.
					...
					Most of the stereo utilities will be created in this iteration.
					If successful and time allows then object detection will be explored here.
			\subsection{Tools}
