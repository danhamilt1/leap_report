...
\title{An Open Source Computer Vision Framework for Leapmotion}
	...
	\chapter{Introduction}\label{chap:introduction}
		...
		\section{Solution Approach}	
			\subsection{Project Goals}
				...
				The secondary goal is to make use of this library in an application that shows successful detection of objects by the leap motion.
